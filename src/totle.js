    ...
    for (const id of payloadIds) {
      ...
      for (const swapEvent of swapEvents) {
        ...
        const ssTx: StandardTx = {
          ...
          inputAmount: parseFloat(sourceAmount.toString()) / (10 ** sourceToken.decimals),
          outputAddress: receipt.from,
          outputCurrency: destinationToken.symbol,
          outputAmount: (parseFloat(destinationAmount.toString()) / (10 ** destinationToken.decimals)).toString(),
          timestamp
        }
        // console.log(ssTx)
